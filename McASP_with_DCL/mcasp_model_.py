...
class McASP(nn.Module):
    ...
    def __init__(self, word2id, gram2id, gram2count, labelmap, hpara,args, model_path):
        super().__init__()
    ...
    def forward(self, input_ids, token_type_ids=None, attention_mask=None, labels=None, valid_ids=None,
                ...
                input_ngram_ids=None, ngram_position_matrix=None, rank=False):
...
#
        ...
        # return -1 * self.crf(emissions=logits, tags=labels, mask=attention_mask_label), self.crf.decode(logits, attention_mask_label)[0]
    ...
    @classmethod
    def load_model(cls, model_path, args):
        ...
        res = cls(model_path=model_path, labelmap=label_map, hpara=hpara,
                  gram2id=gram2id, word2id=word2id, gram2count=gram2count,args=args)
